...
use contracts::starknet_event::interface::IStarknetEvent;
    ...
    fn constructor(
        ...
        self.event_id.write(1);
        self.name.write("Starknet Event #1");
        self.start.write(1718748000);
        self.end.write(1718751600);
        self.location.write("remote");
        self.max_capacity.write(100);
        self.metadata_uri.write("whatever.com");
